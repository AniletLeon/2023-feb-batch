...
public class Random_TC37 extends BaseTest {
	...
	public void blockingAnEventInCalender() throws InterruptedException {
		...
		Thread.sleep(5000);
		randomscenarios.clickOnfourLink();
		randomscenarios.clickOnSubjectComboLink();
		randomscenarios.clickOtherInComboWindow();
		randomscenarios.clickOnEndTime();
		randomscenarios.clickOnSevenLink();
		randomscenarios.clickRecurrence();
		randomscenarios.weeklyRadioButton();
		randomscenarios.recurrencendDate();
		randomscenarios.clicktodayDate();
		randomscenarios.clickOnSaveButton1();
		randomscenarios.clickmonthviewIcon();
