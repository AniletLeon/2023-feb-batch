...
public class Contacts_TC32_checkingButton extends BaseTest {
	...
	public void createnewContact() throws InterruptedException{
		...
		contact.enterCompanyName("Global Media");
		contact.clickOnSaveAndNewButton();
