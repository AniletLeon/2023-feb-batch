...
public class Contacts_TC25_CreateNewContacts extends BaseTest {
	...
	public void createnewContact() throws InterruptedException {
		...
		contact.enterLastName("abcdef");
		contact.enterCompanyName("United Oil & Gas, Singapore");
