...
public class CreateOpty_TC18_StuckOptyReport extends BaseTest {
	...
	public void clickOnStuck() throws InterruptedException {
		createopty.clickonStuckLink();
		validateString(driver.getTitle(), "Stuck Opportunities ~ Salesforce - Developer Edition");
	}
