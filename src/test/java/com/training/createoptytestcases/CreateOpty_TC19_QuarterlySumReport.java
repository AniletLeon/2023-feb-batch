...
public class CreateOpty_TC19_QuarterlySumReport extends BaseTest {
	...
	public void clickOnStuck() throws InterruptedException {
		createopty.clickonOptyDropdownk();
		createopty.clickonIncludeDropDown();
		createopty.clickSave();
		validateString(driver.getTitle(),"Opportunity Report ~ Salesforce - Developer Edition");
