...
public class Leads_TC21_LeadsSelectView extends BaseTest {
	...
	public void clickOnLeadTab()  {
		...
		validateString(driver.getTitle(),"Leads: Home ~ Salesforce - Developer Edition");
	}
