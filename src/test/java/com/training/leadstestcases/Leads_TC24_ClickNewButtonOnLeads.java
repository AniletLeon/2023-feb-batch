...
public class Leads_TC24_ClickNewButtonOnLeads extends BaseTest {
	...
	@Test
	public void newButtonOnLeadHome() throws InterruptedException {
		leadspage.clickNewButtonInLeadTab();
